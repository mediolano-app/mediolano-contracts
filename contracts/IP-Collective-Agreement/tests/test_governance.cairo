...
//     let (contract_address, _, asset_dispatcher, _, _, _, governance_dispatcher, _, owner_address)
//     = setup_with_governance();
//     let (asset_id, _, _, _) = register_test_asset(contract_address, asset_dispatcher,
//     owner_address);
...
//     assert!(default_settings.emergency_quorum_percentage == 3000, "Emergency default should be
//     30%");
//     assert!(default_settings.default_voting_duration == 259200, "Default voting should be 3
//     days");
//     assert!(default_settings.execution_delay == 86400, "Default execution delay should be 1
//     day");
// }
...
//     let (contract_address, _, asset_dispatcher, _, _, _, governance_dispatcher, _, owner_address)
//     = setup_with_governance();
//     let (asset_id, creators, _, _) = register_test_asset(contract_address, asset_dispatcher,
//     owner_address);
//     let creator1 = *creators[0];
...
//     start_cheat_caller_address(contract_address, creator1);
//     let proposal_id = governance_dispatcher.propose_asset_management(
//         asset_id,
//         proposal_data,
//         259200, // 3 days
...
//     assert!(proposal.proposal_type == ProposalType::AssetManagement.into(), "Should be asset
//     management type");
...
//     assert!(updated_asset.metadata_uri == "ipfs://updated-asset-metadata", "Metadata should be
//     updated");
//     assert!(updated_asset.compliance_status == ComplianceStatus::BerneCompliant.into(),
...
//     let proposal_id = governance_dispatcher.propose_asset_management(
//         asset_id, proposal_data, 259200, "Minority proposal"
//     );
...
//     assert!(!governance_dispatcher.check_quorum_reached(proposal_id), "Quorum should not be
//     reached");
...
//     let (contract_address, _, asset_dispatcher, _, revenue_dispatcher, _, governance_dispatcher,
//     erc20_dispatcher, owner_address) = setup_with_governance();
//     let (asset_id, creators, _, _) = register_test_asset(contract_address, asset_dispatcher,
//     owner_address);
//     let creator1 = *creators[0];
//     let creator2 = *creators[1];
...
//     start_cheat_caller_address(contract_address, creator1);
//     let proposal_id = governance_dispatcher.propose_revenue_policy(
...
//     let (contract_address, _, asset_dispatcher, _, _, licensing_dispatcher,
//     governance_dispatcher, erc20_dispatcher, owner_address) = setup_with_governance();
//     let (asset_id, creators, _, _) = register_test_asset(contract_address, asset_dispatcher,
//     owner_address);
//     let creator1 = *creators[0];
//     let creator2 = *creators[1];
...
//         contract_address, licensing_dispatcher, erc20_dispatcher, asset_id, creator1, licensee,
//         1000_u256
//     );

//     // Verify license is active
//     assert!(licensing_dispatcher.is_license_valid(license_id), "License should be active
//     initially");
...
//     start_cheat_caller_address(contract_address, creator1);
//     let proposal_id = governance_dispatcher.propose_emergency_action(
...
//     let proposal = governance_dispatcher.get_governance_proposal(proposal_id);
//     assert!(proposal.proposal_type == ProposalType::Emergency.into(), "Should be emergency
//     type");
...
//     assert!(governance_dispatcher.check_quorum_reached(proposal_id), "Emergency quorum should be
//     reached");
...
//     assert!(!licensing_dispatcher.is_license_valid(license_id), "License should be invalid after
//     suspension");
...
//     let proposal_data = AssetManagementProposal {
//         new_metadata_uri: "ipfs://test", new_compliance_status: 'PENDING',
//         update_metadata: true, update_compliance: false,
//     };

//     start_cheat_caller_address(contract_address, creator1);
//     let proposal_id = governance_dispatcher.propose_asset_management(
//         asset_id, proposal_data, 259200, "Test quorum calculation"
//     );
//     stop_cheat_caller_address(contract_address);

//     // Initially no votes
//     let initial_participation =
//     governance_dispatcher.get_proposal_participation_rate(proposal_id);
...
//     assert!(final_participation == 7500, "Final participation should be 75% (7500 basis
//     points)");
...
//     start_cheat_caller_address(contract_address, creator1);
//     let proposal_id = governance_dispatcher.propose_asset_management(
//         asset_id, proposal_data, 259200, "Double voting test"
//     );
...
//     let proposal_data = AssetManagementProposal {
//         new_metadata_uri: "ipfs://early-execution", new_compliance_status: 'PENDING',
//         update_metadata: true, update_compliance: false,
//     };

//     start_cheat_caller_address(contract_address, creator1);
//     let proposal_id = governance_dispatcher.propose_asset_management(
//         asset_id, proposal_data, 259200, "Early execution test"
//     );
...
//     let proposal_data = AssetManagementProposal {
//         new_metadata_uri: "ipfs://late-execution", new_compliance_status: 'PENDING',
//         update_metadata: true, update_compliance: false,
//     };

//     start_cheat_caller_address(contract_address, creator1);
//     let proposal_id = governance_dispatcher.propose_asset_management(
//         asset_id, proposal_data, 259200, "Late execution test"
//     );
