...
/// All provenance fields for a single ERC-1155 token type.
/// Returned by `get_token_data` in a single call to avoid multiple round-trips.
#[derive(Drop, Serde, starknet::Store)]
pub struct TokenData {
    /// The unique identifier of the token type within this contract.
    pub token_id: u256,
    /// Full content-addressed URI (ipfs:// or ar://). Written once at first mint.
