// //use mediolano_core::mocks::erc20::{IExternalTraitDispatcher as IERC20ExternalTraitDispatcher,
// IExternalTraitDispatcherTrait as IERC20ExternalTraitDispatcherTrait};
// //use mediolano_core::mocks::erc721::{IExternalTraitDispatcher as IERC721ExternalTraitDispatcher,
// IExternalTraitDispatcherTrait as IERC721ExternalTraitDispatcherTrait};
// //use mediolano_core::mocks::erc1155::{IExternalTraitDispatcher as
// IERC1155ExternalTraitDispatcher, IExternalTraitDispatcherTrait as
// IERC1155ExternalTraitDispatcherTrait};
...
//         let signature_tuple = key_pair.sign(order_hash).unwrap();
...
//     fn approve_erc20(
//         contract: IMockERC20Dispatcher, owner: ContractAddress, spender: ContractAddress, amount:
//         u256,
//     ) {
...
//         approve_erc721(
//             contracts.erc721, accounts.offerer, contracts.medialane.contract_address,
//             NFT_TOKEN_ID,
//         );
//         approve_erc20(
//             contracts.erc20, accounts.fulfiller, contracts.medialane.contract_address,
//             ERC20_AMOUNT,
//         );
...
//         let mut order_with_invalid_sig = sign_order(contracts.medialane, parameters,
//         FULFILLER_PK);
...
//         start_cheat_block_timestamp(contracts.medialane.contract_address, parameters.end_time +
//         1);
...
//         );
//         let signed_order_nonce_0 = sign_order(contracts.medialane, parameters_nonce_0,
//         OFFERER_PK);
