...
fn test_mint_item() {
    let your_collectible_contract_address = deploy_contract("Mediolano");
    let your_collectible_dispatcher = IMediolanoDispatcher {
    ...
    // Change the caller address of the Mediolano to the tester_address
