use contract::structs::settings_structs::{
    ...
    GasPricePreference, SocialVerification //, WalletData
};
...
pub trait IEncryptedPreferencesRegistry<TContractState> {
    ...
    // fn store_wallet_data(ref self: TContractState );
    ...
    // READ FUNCTIONS
    fn get_account_settings(self: @TContractState) -> AccountSetting;
    fn get_network_settings(self: @TContractState) -> NetworkSettings;
    fn get_ip_settings(self: @TContractState) -> IPSettings;
    fn get_notification_settings(self: @TContractState) -> NotificationSettings;
    fn get_security_settings(self: @TContractState) -> Security;
    fn get_advanced_settings(self: @TContractState) -> AdvancedSettings;
    fn get_public_key(self: @TContractState) -> felt252;
    fn get_nonce(self: @TContractState) -> felt252;
    fn get_social_verification(self: @TContractState) -> SocialVerification;
}